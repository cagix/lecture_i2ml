...
Choosing parameters as before yields, e.g., $\thetab^\prime = (0.5, -1, -1)^\top$. In practice, we will of course use ERM to estimate, rather than hand-pick, $\bm{\alpha}, \bm{\beta}, \bm{\theta}$.
</details> 
:::
...
![Feedforward neural network](nn.png){width=40%}
</details> 
:::
