...
If you work with `Python`, import the following:

{{< embed _python_2.ipynb#import echo=true >}}
...
$$
\pi_{k}(\mathbf{x})\propto \underbrace{\pi_{k}\cdot \mathbb{P}(x_\text{Color} ~|~ y = k) \cdot \mathbb{P}(x_\text{Form} ~|~ y = k) \cdot \mathbb{P}(x_\text{Origin} ~|~ y = k)}_{=: \alpha_k(x)} \\
...
\hat{\mathbb{P}}(x_\text{Origin} = \text{imported} ~|~ y = \text{yes}) \\
= \frac{3}{8} \cdot \frac{1}{3} \cdot \frac{1}{3} \cdot 1 = \frac{1}{24} 
\approx 0.042
$$

$$
\hat{\alpha}_\text{no}(\mathbf{x}_{\ast}) = \hat{\pi}_{\text{no}} \cdot 
\hat{\mathbb{P}}(x_\text{Color} = \text{yellow} ~|~ y = \text{no})\cdot 
\hat{\mathbb{P}}(x_\text{Form} = \text{round} ~|~ y = \text{no}) \cdot 
\hat{\mathbb{P}}(x_\text{Origin} = \text{imported} ~|~ y = \text{no}) \\
...
::: {.panel-tabset}
### R
{{< embed _r_2.ipynb#naivebayes echo=true >}}
### Python
{{< embed _python_2.ipynb#naivebayes echo=true >}}
:::
...
::: {.panel-tabset}
### R
{{< embed _r_2.ipynb#discriminantanalysis echo=true >}}
### Python
{{< embed _python_2.ipynb#discriminantanalysis echo=true >}}
:::
...
***
Given are two new observations $\xv_{*1} = -10$ and $\xv_{*2} = 7$. State the prediction for QDA and explain how you arrive there.
...
1. Generate 1000 points from `cassini` using R or import [`cassini_data.csv`](https://github.com/slds-lmu/lecture_i2ml/blob/master/exercises/data/cassini_data.csv) in Python.
2. Then, perturb the `x.2` dimension with Gaussian noise (mean 0, standard deviation 0.5), and consider the classifiers already introduced in the lecture:
...
::: {.panel-tabset}
### R
{{< embed _r_2.ipynb#decb-vis echo=true >}}
### Python
{{< embed _python_2.ipynb#decb-vis echo=true >}}
:::
...
::: {.panel-tabset}
### R
{{< embed _r_2.ipynb#decb-learn echo=true >}}
### Python
{{< embed _python_2.ipynb#decb-learn echo=true >}}
:::
...
::: {.panel-tabset}
### R
{{< embed _r_2.ipynb#decb-plot echo=true >}}
### Python
{{< embed _python_2.ipynb#decb-plot echo=true >}}
:::
