...
***
Evaluate both learners on the following test data ($n_{test} = 10$), using 
...
Use `R` or `Python` if you don't feel like computing a degree-21 polynomial regression by hand.

::: {.panel-tabset}
### R
{{< embed ex_eval_1_R.ipynb#regr-hint echo=true >}}
### Python
{{< embed ex_eval_1_py.ipynb#regr-hint echo=true >}}
:::
</details>
...
::: {.panel-tabset}
### R
{{< embed sol_eval_1_R.ipynb#fit echo=true >}}
### Python
{{< embed sol_eval_1_py.ipynb#train echo=true >}}
{{< embed sol_eval_1_py.ipynb#test echo=true >}}
{{< embed sol_eval_1_py.ipynb#fit echo=true >}}
:::
...
::: {.panel-tabset}
### R
{{< embed ex_eval_1_R.ipynb#ex2 echo=true >}}
### Python
{{< embed ex_eval_1_py.ipynb#ex2 echo=true >}}
:::

***
a) Use the first ten observations as training data to compute a linear model and evaluate the performance of your learner on the remaining data using MSE.
...
::: {.panel-tabset}
### R
{{< embed sol_eval_1_R.ipynb#lin-model echo=true >}}
### Python
{{< embed sol_eval_1_py.ipynb#lin-model echo=true >}}
:::
...
::: {.panel-tabset}
### R
```{r, echo=FALSE, results=FALSE, message=FALSE, fig.height=3, fig.width=3}
...
```
```{r, echo=TRUE, results=FALSE, message=FALSE, fig.height=3, fig.width=3}
...
{{< embed sol_eval_1_R.ipynb#plot echo=true >}}

### Python
{{< embed sol_eval_1_py.ipynb#split echo=true >}}
{{< embed sol_eval_1_py.ipynb#plot echo=true >}}
:::
...
<details> 
<summary>**Solution**</summary>
From the experiment in c) we can derive two conclusions:
